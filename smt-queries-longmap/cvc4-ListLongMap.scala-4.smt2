...
(assert (=> b!1803 (=> (not res!4390) (not e!332))))
...
(assert (=> start!158 (=> (not res!4389) (not e!332))))
...
(assert (=> start!158 e!332))

(declare-fun inv!41 (ListLongMap!27) Bool)

(assert (=> start!158 (and (inv!41 lm!258) e!333)))
...
(assert (=> b!1804 (=> (not res!4391) (not e!332))))
