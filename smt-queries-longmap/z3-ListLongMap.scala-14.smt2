...
(assert (=> b!2771 (=> (not res!4835) (not e!1115))))
...
(declare-datatypes ((array!71 0))(
  ( (array!72 (arr!33 (Array (_ BitVec 32) (_ BitVec 64))) (size!95 (_ BitVec 32))) )
))
(declare-fun _keys!1806 () array!71)

(declare-fun extraKeys!1413 () (_ BitVec 32))

(assert (=> b!2771 (= res!4835 (and (= (size!94 _values!1492) (bvadd #b00000000000000000000000000000001 mask!2250)) (= (size!95 _keys!1806) (size!94 _values!1492)) (bvsge mask!2250 #b00000000000000000000000000000000) (bvsge extraKeys!1413 #b00000000000000000000000000000000) (bvsle extraKeys!1413 #b00000000000000000000000000000011)))))
...
(assert (=> start!470 (=> (not res!4834) (not e!1115))))

(declare-fun validMask!0 ((_ BitVec 32)) Bool)

(assert (=> start!470 (= res!4834 (validMask!0 mask!2250))))

(assert (=> start!470 e!1115))

(assert (=> start!470 true))

(declare-fun e!1119 () Bool)

(declare-fun array_inv!15 (array!69) Bool)

(assert (=> start!470 (and (array_inv!15 _values!1492) e!1119)))

(declare-fun array_inv!16 (array!71) Bool)

(assert (=> start!470 (array_inv!16 _keys!1806)))
...
(assert (=> b!2773 (=> (not res!4833) (not e!1115))))

(declare-fun arrayForallSeekEntryOrOpenFound!0 ((_ BitVec 32) array!71 (_ BitVec 32)) Bool)
...
(assert (=> b!2774 (= e!1118 tp_is_empty!69)))

(declare-fun b!2775 () Bool)

(assert (=> b!2775 (= e!1119 (and e!1116 mapRes!47))))

(declare-fun condMapEmpty!47 () Bool)

(declare-fun mapDefault!47 () ValueCell!18)

(assert (=> b!2775 (= condMapEmpty!47 (= (arr!32 _values!1492) ((as const (Array (_ BitVec 32) ValueCell!18)) mapDefault!47)))))

(declare-fun b!2776 () Bool)

(assert (=> b!2776 (= e!1115 (bvsgt #b00000000000000000000000000000000 (size!95 _keys!1806)))))

(declare-fun mapNonEmpty!47 () Bool)

(declare-fun tp!287 () Bool)

(assert (=> mapNonEmpty!47 (= mapRes!47 (and tp!287 e!1118))))
...
(assert (= (and start!470 res!4834) b!2771))

(assert (= (and b!2771 res!4835) b!2773))

(assert (= (and b!2773 res!4833) b!2776))

(assert (= (and b!2775 condMapEmpty!47) mapIsEmpty!47))

(assert (= (and b!2775 (not condMapEmpty!47)) mapNonEmpty!47))

(get-info :version)

(assert (= (and mapNonEmpty!47 ((_ is ValueCellFull!18) mapValue!47)) b!2774))

(assert (= (and b!2775 ((_ is ValueCellFull!18) mapDefault!47)) b!2772))

(assert (= start!470 b!2775))
...
(check-sat (not start!470) (not b!2773) (not mapNonEmpty!47) tp_is_empty!69)
(check-sat)
(get-model)
...
(assert (=> start!470 d!573))

(declare-fun d!575 () Bool)

(assert (=> d!575 (= (array_inv!15 _values!1492) (bvsge (size!94 _values!1492) #b00000000000000000000000000000000))))

(assert (=> start!470 d!575))

(declare-fun d!577 () Bool)

(assert (=> d!577 (= (array_inv!16 _keys!1806) (bvsge (size!95 _keys!1806) #b00000000000000000000000000000000))))
...
(assert (=> b!2804 (= c!176 (validKeyInArray!0 (select (arr!33 _keys!1806) #b00000000000000000000000000000000)))))
...
(assert (=> d!579 (= res!4849 (bvsge #b00000000000000000000000000000000 (size!95 _keys!1806)))))
...
(declare-fun lt!386 () (_ BitVec 64))

(assert (=> b!2806 (= lt!386 (select (arr!33 _keys!1806) #b00000000000000000000000000000000))))
...
(declare-fun lemmaArrayContainsFromImpliesContainsFromZero!0 (array!71 (_ BitVec 64) (_ BitVec 32)) Unit!19)

(assert (=> b!2806 (= lt!384 (lemmaArrayContainsFromImpliesContainsFromZero!0 _keys!1806 lt!386 #b00000000000000000000000000000000))))

(declare-fun arrayContainsKey!0 (array!71 (_ BitVec 64) (_ BitVec 32)) Bool)

(assert (=> b!2806 (arrayContainsKey!0 _keys!1806 lt!386 #b00000000000000000000000000000000)))

(declare-fun lt!385 () Unit!19)

(assert (=> b!2806 (= lt!385 lt!384)))
...
(declare-fun seekEntryOrOpen!0 ((_ BitVec 64) array!71 (_ BitVec 32)) SeekEntryResult!5)

(assert (=> b!2806 (= res!4850 (= (seekEntryOrOpen!0 (select (arr!33 _keys!1806) #b00000000000000000000000000000000) _keys!1806 mask!2250) (Found!5 #b00000000000000000000000000000000)))))
...
(assert (=> mapNonEmpty!53 (= mapRes!53 (and tp!293 e!1148))))
...
(assert (=> b!2814 (= e!1149 tp_is_empty!69)))
...
(assert (=> mapNonEmpty!47 (= tp!287 (and e!1149 mapRes!53))))

(declare-fun b!2813 () Bool)

(assert (=> b!2813 (= e!1148 tp_is_empty!69)))
...
(check-sat (not b!2804) tp_is_empty!69 (not b!2806) (not bm!29) (not mapNonEmpty!53))
(check-sat)
