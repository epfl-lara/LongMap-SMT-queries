...
(assert (=> b!2845 (=> (not res!4866) (not e!1176))))
...
(declare-datatypes ((array!83 0))(
  ( (array!84 (arr!38 (Array (_ BitVec 32) ValueCell!21)) (size!100 (_ BitVec 32))) )
))
(declare-fun _values!1492 () array!83)

(declare-datatypes ((array!85 0))(
  ( (array!86 (arr!39 (Array (_ BitVec 32) (_ BitVec 64))) (size!101 (_ BitVec 32))) )
))
(declare-fun _keys!1806 () array!85)

(declare-fun extraKeys!1413 () (_ BitVec 32))

(assert (=> b!2845 (= res!4866 (and (= (size!100 _values!1492) (bvadd #b00000000000000000000000000000001 mask!2250)) (= (size!101 _keys!1806) (size!100 _values!1492)) (bvsge mask!2250 #b00000000000000000000000000000000) (bvsge extraKeys!1413 #b00000000000000000000000000000000) (bvsle extraKeys!1413 #b00000000000000000000000000000011)))))
...
(assert (=> b!2846 (= e!1179 (and e!1178 mapRes!59))))

(declare-fun condMapEmpty!59 () Bool)

(declare-fun mapDefault!59 () ValueCell!21)

(assert (=> b!2846 (= condMapEmpty!59 (= (arr!38 _values!1492) ((as const (Array (_ BitVec 32) ValueCell!21)) mapDefault!59)))))
...
(assert (=> b!2847 (= e!1177 tp_is_empty!75)))

(declare-fun b!2848 () Bool)

(assert (=> b!2848 (= e!1176 (and (bvsle #b00000000000000000000000000000000 (size!101 _keys!1806)) (bvsge (size!101 _keys!1806) #b01111111111111111111111111111111)))))
...
(assert (=> b!2850 (=> (not res!4867) (not e!1176))))

(declare-fun arrayForallSeekEntryOrOpenFound!0 ((_ BitVec 32) array!85 (_ BitVec 32)) Bool)

(assert (=> b!2850 (= res!4867 (arrayForallSeekEntryOrOpenFound!0 #b00000000000000000000000000000000 _keys!1806 mask!2250))))

(declare-fun res!4868 () Bool)

(assert (=> start!484 (=> (not res!4868) (not e!1176))))

(declare-fun validMask!0 ((_ BitVec 32)) Bool)

(assert (=> start!484 (= res!4868 (validMask!0 mask!2250))))

(assert (=> start!484 e!1176))

(assert (=> start!484 true))

(declare-fun array_inv!19 (array!83) Bool)

(assert (=> start!484 (and (array_inv!19 _values!1492) e!1179)))

(declare-fun array_inv!20 (array!85) Bool)

(assert (=> start!484 (array_inv!20 _keys!1806)))

(declare-fun mapNonEmpty!59 () Bool)

(declare-fun tp!299 () Bool)

(assert (=> mapNonEmpty!59 (= mapRes!59 (and tp!299 e!1177))))
...
(assert (=> mapNonEmpty!59 (= (arr!38 _values!1492) (store mapRest!59 mapKey!59 mapValue!59))))
...
(assert (= (and b!2845 res!4866) b!2850))

(assert (= (and b!2850 res!4867) b!2848))
...
(assert (=> start!484 m!1275))

(declare-fun m!1277 () Bool)

(assert (=> mapNonEmpty!59 m!1277))
...
(assert (=> d!583 (=> res!4883 e!1203)))

(assert (=> d!583 (= res!4883 (bvsge #b00000000000000000000000000000000 (size!101 _keys!1806)))))

(assert (=> d!583 (= (arrayForallSeekEntryOrOpenFound!0 #b00000000000000000000000000000000 _keys!1806 mask!2250) e!1203)))

(declare-fun b!2878 () Bool)

(declare-fun e!1201 () Bool)

(assert (=> b!2878 (= e!1201 e!1202)))

(declare-fun lt!393 () (_ BitVec 64))

(assert (=> b!2878 (= lt!393 (select (arr!39 _keys!1806) #b00000000000000000000000000000000))))
...
(declare-fun lemmaArrayContainsFromImpliesContainsFromZero!0 (array!85 (_ BitVec 64) (_ BitVec 32)) Unit!21)

(assert (=> b!2878 (= lt!395 (lemmaArrayContainsFromImpliesContainsFromZero!0 _keys!1806 lt!393 #b00000000000000000000000000000000))))

(declare-fun arrayContainsKey!0 (array!85 (_ BitVec 64) (_ BitVec 32)) Bool)

(assert (=> b!2878 (arrayContainsKey!0 _keys!1806 lt!393 #b00000000000000000000000000000000)))

(declare-fun lt!394 () Unit!21)

(assert (=> b!2878 (= lt!394 lt!395)))
...
(declare-fun seekEntryOrOpen!0 ((_ BitVec 64) array!85 (_ BitVec 32)) SeekEntryResult!6)

(assert (=> b!2878 (= res!4882 (= (seekEntryOrOpen!0 (select (arr!39 _keys!1806) #b00000000000000000000000000000000) _keys!1806 mask!2250) (Found!6 #b00000000000000000000000000000000)))))

(assert (=> b!2878 (=> (not res!4882) (not e!1202))))

(declare-fun b!2879 () Bool)

(assert (=> b!2879 (= e!1201 call!35)))

(declare-fun b!2880 () Bool)

(assert (=> b!2880 (= e!1203 e!1201)))

(declare-fun c!179 () Bool)

(declare-fun validKeyInArray!0 ((_ BitVec 64)) Bool)

(assert (=> b!2880 (= c!179 (validKeyInArray!0 (select (arr!39 _keys!1806) #b00000000000000000000000000000000)))))

(assert (= (and d!583 (not res!4883)) b!2880))

(assert (= (and b!2880 c!179) b!2878))

(assert (= (and b!2880 (not c!179)) b!2879))

(assert (= (and b!2878 res!4882) b!2877))

(assert (= (or b!2877 b!2879) bm!32))
...
(assert (=> b!2878 m!1293))

(declare-fun m!1295 () Bool)

(assert (=> b!2878 m!1295))

(assert (=> b!2878 m!1291))

(declare-fun m!1297 () Bool)

(assert (=> b!2878 m!1297))

(assert (=> b!2880 m!1291))

(assert (=> b!2880 m!1291))

(declare-fun m!1299 () Bool)

(assert (=> b!2880 m!1299))
...
(assert (=> d!587 (= (array_inv!19 _values!1492) (bvsge (size!100 _values!1492) #b00000000000000000000000000000000))))

(assert (=> start!484 d!587))

(declare-fun d!589 () Bool)

(assert (=> d!589 (= (array_inv!20 _keys!1806) (bvsge (size!101 _keys!1806) #b00000000000000000000000000000000))))
...
(check-sat (not b!2878) tp_is_empty!75 (not b!2880) (not mapNonEmpty!65) (not bm!32))
(check-sat)
