...
(declare-datatypes ((array!55 0))(
  ( (array!56 (arr!26 (Array (_ BitVec 32) ValueCell!15)) (size!88 (_ BitVec 32))) )
))
(declare-fun _values!1492 () array!55)

(declare-datatypes ((array!57 0))(
  ( (array!58 (arr!27 (Array (_ BitVec 32) (_ BitVec 64))) (size!89 (_ BitVec 32))) )
))
(declare-fun _keys!1806 () array!57)

(declare-fun extraKeys!1413 () (_ BitVec 32))

(declare-fun b!2717 () Bool)

(assert (=> b!2717 (= e!1064 (and (= (size!88 _values!1492) (bvadd #b00000000000000000000000000000001 mask!2250)) (= (size!89 _keys!1806) (size!88 _values!1492)) (bvsge mask!2250 #b00000000000000000000000000000000) (bvsge extraKeys!1413 #b00000000000000000000000000000000) (bvsle extraKeys!1413 #b00000000000000000000000000000011) (= (size!89 _keys!1806) (bvadd #b00000000000000000000000000000001 mask!2250)) (bvsgt #b00000000000000000000000000000000 (size!89 _keys!1806))))))
...
(assert (=> b!2718 (= e!1066 tp_is_empty!63)))

(declare-fun b!2719 () Bool)

(declare-fun e!1068 () Bool)

(assert (=> b!2719 (= e!1068 tp_is_empty!63)))

(declare-fun res!4814 () Bool)

(assert (=> start!458 (=> (not res!4814) (not e!1064))))

(declare-fun validMask!0 ((_ BitVec 32)) Bool)

(assert (=> start!458 (= res!4814 (validMask!0 mask!2250))))

(assert (=> start!458 e!1064))

(assert (=> start!458 true))

(declare-fun e!1065 () Bool)

(declare-fun array_inv!11 (array!55) Bool)

(assert (=> start!458 (and (array_inv!11 _values!1492) e!1065)))

(declare-fun array_inv!12 (array!57) Bool)

(assert (=> start!458 (array_inv!12 _keys!1806)))

(declare-fun b!2720 () Bool)

(declare-fun mapRes!35 () Bool)

(assert (=> b!2720 (= e!1065 (and e!1066 mapRes!35))))

(declare-fun condMapEmpty!35 () Bool)

(declare-fun mapDefault!35 () ValueCell!15)

(assert (=> b!2720 (= condMapEmpty!35 (= (arr!26 _values!1492) ((as const (Array (_ BitVec 32) ValueCell!15)) mapDefault!35)))))

(declare-fun mapNonEmpty!35 () Bool)

(declare-fun tp!275 () Bool)

(assert (=> mapNonEmpty!35 (= mapRes!35 (and tp!275 e!1068))))
...
(assert (=> mapNonEmpty!35 (= (arr!26 _values!1492) (store mapRest!35 mapKey!35 mapValue!35))))

(declare-fun mapIsEmpty!35 () Bool)

(assert (=> mapIsEmpty!35 mapRes!35))

(assert (= (and start!458 res!4814) b!2717))

(assert (= (and b!2720 condMapEmpty!35) mapIsEmpty!35))

(assert (= (and b!2720 (not condMapEmpty!35)) mapNonEmpty!35))

(get-info :version)

(assert (= (and mapNonEmpty!35 ((_ is ValueCellFull!15) mapValue!35)) b!2719))

(assert (= (and b!2720 ((_ is ValueCellFull!15) mapDefault!35)) b!2718))

(assert (= start!458 b!2720))

(declare-fun m!1197 () Bool)

(assert (=> start!458 m!1197))
...
(assert (=> d!567 (= (array_inv!11 _values!1492) (bvsge (size!88 _values!1492) #b00000000000000000000000000000000))))

(assert (=> start!458 d!567))

(declare-fun d!569 () Bool)

(assert (=> d!569 (= (array_inv!12 _keys!1806) (bvsge (size!89 _keys!1806) #b00000000000000000000000000000000))))
...
(assert (=> mapNonEmpty!35 (= tp!275 (and e!1088 mapRes!41))))
...
(assert (=> b!2740 (= e!1088 tp_is_empty!63)))
...
(assert (=> mapNonEmpty!41 (= mapRes!41 (and tp!281 e!1089))))
...
(assert (=> b!2739 (= e!1089 tp_is_empty!63)))
