...
(assert (=> b!1780 (= res!4372 (not (= (_1!9 (head!743 (toList!27 lm!258))) k0!394)))))
...
(check-sat (not b!1782) (not b!1780) (not b!1781) (not start!154) (not b_next!19) (not b!1779) b_and!43)
