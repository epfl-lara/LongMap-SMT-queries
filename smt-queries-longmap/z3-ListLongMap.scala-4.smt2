...
(assert (=> start!156 (= tp!67 b_and!45)))
...
(assert (=> b!1792 (=> (not res!4380) (not e!327))))
...
(assert (=> b!1792 (= res!4380 (not (= (_1!10 (head!744 (toList!28 lm!258))) k0!394)))))
...
(assert (=> start!156 (=> (not res!4381) (not e!327))))

(assert (=> start!156 (= res!4381 (forall!12 (toList!28 lm!258) p!318))))
...
(assert (=> b!1791 (=> (not res!4382) (not e!327))))

(declare-fun isEmpty!17 (ListLongMap!25) Bool)

(assert (=> b!1791 (= res!4382 (not (isEmpty!17 lm!258)))))

(declare-fun b!1794 () Bool)

(declare-fun tp!68 () Bool)

(assert (=> b!1794 (= e!326 tp!68)))

(assert (= (and start!156 res!4381) b!1791))

(assert (= (and b!1791 res!4382) b!1792))

(assert (= (and b!1792 res!4380) b!1793))
...
(check-sat (not b!1791) b_and!45 (not start!156) (not b!1792) (not b_next!21) (not b!1794) (not b!1793))
